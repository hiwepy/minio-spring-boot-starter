...
[![Maven Central](https://img.shields.io/maven-central/v/io.github.easy4j/minio-spring-boot-starter)](https://github.com/easy-4-java/minio-spring-boot-starter)
...
> **Artifact ID**：`minio-spring-boot-starter`<br>
> **License**：Apache License 2.0<br>

## 1. Positioning

**minio-spring-boot-starter** is a Spring Boot starter that integrates **minio** for applications using minio. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume minio capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using minio |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for minio |
| JDK | `17` |
| Coordinates | `io.github.easy4j:minio-spring-boot-starter:2.3.x.20260527-SNAPSHOT` |
| Config Prefix | `minio` |
...
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers minio beans automatically |
| Property Binding | ✅ Stable | Binds `minio.*` to `MinioProperties` |
| `MinioClient` bean | ✅ Stable | Auto-registered via MinioAutoConfiguration |
...
|---|---|---|
| `MinioClient` | classpath + property | not created |
...
|---|---|---|:---:|---|:---:|
| `minio.enabled` | boolean | `true` | No | Enable the starter | No |
...
```bash
mvn clean verify
mvn -pl minio-spring-boot-starter -am test
```
...
|---|---|---|
| Bean not created | Check auto-configuration report | Verify `minio.enabled=true` and classpath |
...
[Back to top](#readme-top) · [Issues](https://github.com/easy-4-java/minio-spring-boot-starter/issues) · [Repository](https://github.com/easy-4-java/minio-spring-boot-starter)
